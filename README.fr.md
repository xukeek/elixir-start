...
Le projet expose une route `GET /health` qui sert le module `NotionReaderHealth`. Ce module contient différents _checks_ qui s’assurent que l’application et ses services dépendants sont en santé.
