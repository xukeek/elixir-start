...
The project exposes a `GET /health` route that serves the `NotionReaderHealth` module. This module contains checks to make sure the application and its external dependencies are healthy.
