defmodule NotionReaderWeb.Errors do
  alias Ecto.Changeset
  alias NotionReaderWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(NotionReader.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(NotionReader.Gettext, "errors", message, options)
    end
  end
